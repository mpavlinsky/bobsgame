	...
	namespace Skin
	{
		namespace Texturing
		{
			struct Single
			{
				...
				void Draw( Gwen::Renderer::Base* render, Gwen::Rect r, const Gwen::Color & col = Gwen::Color(255,255,255,255) )
				{
					if ( !texture ) { return; }
				...
				void DrawCenter( Gwen::Renderer::Base* render, Gwen::Rect r, const Gwen::Color & col = Gwen::Color(255,255,255,255) )
				{
					if ( !texture ) { return; }
			...
			struct Bordered
			{
				...
				void Draw( Gwen::Renderer::Base* render, Gwen::Rect r, const Gwen::Color & col = Gwen::Color(255,255,255,255), bool b1 = true, bool b2 = true, bool b3 = true, bool b4 = true, bool b5 = true, bool b6 = true, bool b7 = true, bool b8 = true, bool b9 = true )
				{
					if ( !texture ) { return; }
