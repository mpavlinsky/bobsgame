		...
		class TexturedBase : public Gwen::Skin::Base
		{
			public:
				...
				virtual void DrawGroupBox( Gwen::Controls::Base* control, int textStart, int textHeight, int textWidth )
				{
					...
					Textures.GroupBox.Draw( GetRender(), rect, Gwen::Color(255,255,255,255), true, false );
					rect.x += textStart + textWidth - 4;
					rect.w -= textStart + textWidth - 4;
					Textures.GroupBox.Draw( GetRender(), rect, Gwen::Color(255,255,255,255), false, true, false, false, false, false, false, false, false );
				}
