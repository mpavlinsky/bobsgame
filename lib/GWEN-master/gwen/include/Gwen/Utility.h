...
#pragma warning( pop )
		...
		//{
			...
			void Split( const Gwen::String & str, const Gwen::String & seperator, List & outbits, bool bLeaveSeperators = false );
			void Split( const Gwen::UnicodeString & str, const Gwen::UnicodeString & seperator, UnicodeList & outbits, bool bLeaveSeperators = false );
			...
			namespace To
			{
				 bool GwenBool( const Gwen::String & str );
				 int GwenInt( const Gwen::String & str );
				 float GwenFloat( const Gwen::String & str );
				 float GwenFloat( const Gwen::UnicodeString & str );
				 bool GwenFloats( const Gwen::String & str, float* f, size_t iCount );
			}
		//}
	}
