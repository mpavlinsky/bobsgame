		...
		namespace Property
		{
			class ColorSelector : public Property::Text
			{
					...
					void OnButtonPress( Controls::Base* control )
					{
						...
						Gwen::Utility::To::GwenFloats( m_TextBox->GetText().Get(), defaultColor, 3 );
					...
					virtual void DoChanged()
					{
						BaseClass::DoChanged();
						float col[3];
						Gwen::Utility::To::GwenFloats( m_TextBox->GetText().Get(), col, 3 );
