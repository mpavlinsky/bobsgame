...
void Gwen::Utility::Split( const Gwen::String & str, const Gwen::String & seperator, List & outbits, bool bLeave )
{
	int iOffset = 0;
...
void Gwen::Utility::Split( const Gwen::UnicodeString & str, const Gwen::UnicodeString & seperator, UnicodeList & outbits, bool bLeave )
{
	int iOffset = 0;
	int iLength = str.length();
	int iSepLen = seperator.length();
...
int Gwen::Utility::To::GwenInt( const Gwen::String & str )
{
	if ( str == "" ) { return 0; }
...
float Gwen::Utility::To::GwenFloat( const Gwen::String & str )
{
	if ( str == "" ) { return 0.0f; }
...
float Gwen::Utility::To::GwenFloat( const Gwen::UnicodeString & str )
{
	return wcstod( str.c_str(), NULL );
}

bool Gwen::Utility::To::GwenBool( const Gwen::String & str )
{
...
bool Gwen::Utility::To::GwenFloats( const Gwen::String & str, float* f, size_t iCount )
{
	List lst;
	Split( str, " ", lst );
...
bool Gwen::Utility::Wildcard( const Gwen::TextObject & strWildcard, const Gwen::TextObject & strHaystack )
{
...
void Gwen::Utility::ToUpper( Gwen::UnicodeString & str )
{
	transform( str.begin(), str.end(), str.begin(), towupper );
}

void Gwen::Utility::Strip( Gwen::UnicodeString & str, const Gwen::UnicodeString & chars )
{
