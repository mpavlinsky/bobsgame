...
module SoLoud
	...
	class AudioAttenuator
		...
		attr_accessor :objhandle
		def initialize(*args)
			@objhandle = SoLoud::CAPI.AudioAttenuator_create()
		end
		def destroy()
			SoLoud::CAPI.AudioAttenuator_destroy(@objhandle)
		end
	def attenuate(aDistance, aMinDistance, aMaxDistance, aRolloffFactor)
		SoLoud::CAPI.AudioAttenuator_attenuate(@objhandle, aDistance, aMinDistance, aMaxDistance, aRolloffFactor)
		end
	end
	...
	def load_mem(aMem, aLength, aCopy=false, aTakeOwnership=true)
		SoLoud::CAPI.Modplug_loadMemEx(@objhandle, aMem, aLength, aCopy, aTakeOwnership)
		end
	def load_file(aFile)
		SoLoud::CAPI.Modplug_loadFile(@objhandle, aFile)
		end
	def set_volume(aVolume)
		SoLoud::CAPI.Modplug_setVolume(@objhandle, aVolume)
		end
	def set_looping(aLoop)
	...
	def set_3d_attenuator(aAttenuator)
		SoLoud::CAPI.Modplug_set3dAttenuator(@objhandle, aAttenuator.objhandle)
		end
	def set_inaudible_behavior(aMustTick, aKill)
		SoLoud::CAPI.Modplug_setInaudibleBehavior(@objhandle, aMustTick, aKill)
		end
	def set_filter(aFilterId, aFilter)
	...
	def set_3d_processing(aDo3dProcessing)
		SoLoud::CAPI.TedSid_set3dProcessing(@objhandle, aDo3dProcessing)
		end
	def set_3d_listener_relative(aListenerRelative)
