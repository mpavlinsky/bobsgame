...
void main(void)
{
	...
	if((color.r!=color.b||color.r!=color.g||color.r>(5.0f/255.0f))&&(color.r<(200.0f/255.0f)&&color.b<(200.0f/255.0f)&&color.g<(200.0f/255.0f)))
	{

		//gamma
		texel = pow(texel, vec4(Gamma));

		color     = texel.rgb;


		if(color.r!=color.b||color.r!=color.g)color.b+=(5.0f/255.0f);
		//color.g-=(5.0f/255.0f);
