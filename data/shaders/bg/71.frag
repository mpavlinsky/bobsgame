...
float pattern(  vec2 p, out vec2 q, out vec2 r )
{
	...
	r.x = fbm( p +1.0*q + vec2(1.7,9.2)+0.55*time );
	r.y = fbm( p+ 1.0*q + vec2(8.3,2.8)+0.626*time);
	//r = cMul(q,q+0.1*time);
	return fbm(p +1.0*r + 0.1* time);
}

const vec3 color1 = vec3(0.8,0.1,0.9);
const vec3 color2 = vec3(0.7,0.0,0.5);
const vec3 color3 = vec3(0,0,0.2);
